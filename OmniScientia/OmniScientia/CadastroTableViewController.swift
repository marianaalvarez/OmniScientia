...
class CadastroTableViewController: UITableViewController {
    ...
    @IBAction func salvarDados(sender: UIButton) {
        
        cloudKitHelper.salvaUsuario(self.nome.text, senha: self.senha.text, nome: self.nome.text, email: self.email.text, sexo: self.sexo.text)
        NSLog("Passou")
